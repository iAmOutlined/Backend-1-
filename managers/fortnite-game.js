        ...
        res.json({
                    ...
                    "emergencynotices": [
                        {
                            ...
                            "title": "Switched",
                            "body": "Welcome to Switched Dev Made By Psycho\nhttps://dsc.gg/SwitchedFN ",
                        }
                    ]
                },
                "_activeDate": "2018-08-06T19:00:26.217Z",
           ...
           "battleroyalenewsv2": {
                "news": {
                    "motds": [{
                        "entryType": "Website",
                        "image": `https://i.imgur.com/xIjUrVM.jpg`,
                        "tileImage": `https://i.imgur.com/xIjUrVM.jpg`,
                        "videoMute": false,
                        "hidden": false,
                        "tabTitleOverride": "USE CODE Switched",
                        "_type": "CommonUI Simple Message MOTD",
                        "title": "Switched",
                        "body": "Made by pyscho And Foco\nCredits: Psycho , Foco",
                        "videoLoop": false,
                        ...
                        "websiteButtonText": "Join Discord RIGHT NOW"
                    }]
                },
                 "jcr:isCheckedOut": true,
            ...
            "shopCarousel": {
                ...
                "itemsList": {
                    ...
                    "items": [{
                        "tileImage": `https://media.discordapp.net/attachments/973471317686911017/1036324161792000070/secret.png`,
                        "fullTitle": "Switched",
                        "hidden": false,
            ...
            "dynamicbackgrounds": {
                ...
                "backgrounds": {
                      "backgrounds": [
                        {
                          "backgroundimage": 'https://wallpaperaccess.com/full/1761712.jpg',
                            "stage": `defaultnotris`,
            ...
            "_suggestedPrefetch": [
                `https://media.discordapp.net/attachments/973471317686911017/1036324161792000070/secret.png`
            ]
        })
    })
